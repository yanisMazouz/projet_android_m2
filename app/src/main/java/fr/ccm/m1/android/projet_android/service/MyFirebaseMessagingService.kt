package fr.ccm.m1.android.tp_android.architecture.service
...
import fr.ccm.m1.android.projet_android.view.Fonctionnalite1Activity
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendNotification(remoteMessageNotification: RemoteMessage.Notification) {
        val intent = Intent(this, Fonctionnalite1Activity::class.java).also {
